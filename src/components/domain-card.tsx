...
export function DomainCard({
  ...
  return (
    <Link
      ...
      className="group relative flex flex-col justify-between overflow-hidden rounded-xl border border-border/60 bg-card p-5 transition-colors hover:border-border"
